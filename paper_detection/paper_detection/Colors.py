class Colors:
    def __init__(self):
        ...
        self.if_red_value = self.START_Z + 0.20
        self.if_green_value = self.START_Z + 0.30
        self.if_blue_value = self.START_Z + 0.40
        self.if_black_value = self.START_Z + 0.50
        self.if_yellow_value = self.START_Z + 0.60
